...
def select_all_matches_with_player_stats_and_goals(conn):
    ...
    cur = conn.cursor()
    cur.execute("SELECT home_player_9, home_player_10, home_player_11, goal FROM Match WHERE home_player_9 is not NULL AND home_player_10 is not NULL AND home_player_11 is not NULL AND goal is not NULL")
    #cur.execute("SELECT home_player_9, home_player_10, home_player_11, shoton FROM Match WHERE home_player_9 is not NULL AND home_player_10 is not NULL AND home_player_11 is not NULL AND shoton is not NULL")
    home_players = cur.fetchall()

    cur.execute("SELECT away_player_9, away_player_10, away_player_11, goal FROM Match WHERE away_player_9 is not NULL AND away_player_10 is not NULL AND away_player_11 is not NULL AND goal is not NULL")
    #cur.execute("SELECT away_player_9, away_player_10, away_player_11, shoton FROM Match WHERE away_player_9 is not NULL AND away_player_10 is not NULL AND away_player_11 is not NULL AND shoton is not NULL")
...
with open('players_with_avg_goals_2.csv', mode='w') as players_file:
